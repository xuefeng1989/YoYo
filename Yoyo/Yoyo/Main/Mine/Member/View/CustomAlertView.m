...
- (void)setupUI {
    ...
    self.line1 = [self lineview];
    [self.titleLabel addSubview:self.line1];
...
- (UIView *)lineview{
    ...
    view.frame = CGRectMake(20, 0, kScreenWidth * 0.8 - 20, 1);
    return view;
}
#pragma mark - 布局
-(void)layoutSubviews {
    ...
    self.line1.frame = CGRectMake(20, titleH - 1, w -20, 1);
    CGFloat msgX = 10;
