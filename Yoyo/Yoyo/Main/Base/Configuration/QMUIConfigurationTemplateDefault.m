...
#pragma mark - TextField & TextView
    QMUICMI.textFieldTintColor = UIColorGlobal; //self.themeTintColor;                           // TextFieldTintColor : QMUITextField、QMUITextView 的 tintColor，不影响 UIKit 的输入框
...
#pragma mark - NavigationBar
    ...
    QMUICMI.navBarBackgroundImage = [YoUIHelper navigationBarBackgroundImageWithThemeColor:self.themeTintColor]; // // NavBarBackgroundImage : UINavigationBar 的背景图，注意 navigationBar 的高度会受多个因素（是否全面屏、是否使用了 navigationItem.prompt、是否将 UISearchBar 作为 titleView）的影响，要检查各种情况是否都显示正常。
...
#pragma mark - TabBar
    ...
    QMUICMI.tabBarTintColor = UIColorGlobal;                              // TabBarTintColor : UITabBar 的 tintColor
...
#pragma mark - SearchBar
    ...
    QMUICMI.searchBarTintColor = UIColorGlobal;//self.themeTintColor;                           // SearchBarTintColor : QMUISearchBar 的 tintColor，也即上面的操作控件的主题色
    ...
    QMUICMI.searchBarTextFieldCornerRadius = 5.0;                               // SearchBarTextFieldCornerRadius : QMUISearchBar 里的文本框的圆角大小，-1 表示圆角大小为输入框高度的一半
...
#pragma mark - TableView / TableViewCell
    ...
    QMUICMI.tableViewCellTitleLabelColor = UIColorMake(0, 0, 0);                        // TableViewCellTitleLabelColor : QMUITableViewCell 的 textLabel 的文字颜色
