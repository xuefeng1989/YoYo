...
@interface YoHomeWomanNearController ()

@end

@implementation YoHomeWomanNearController
...
- (void)tableViewDidTriggerHeaderRefresh {
    ...
    HomeListService *listApi = [[HomeListService alloc] initWithPageNum:self.page pageSize:ceilf(SCREEN_HEIGHT/100) homeType:YoHomeTypeWomanNear];
