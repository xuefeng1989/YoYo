...
@interface YoHomeWomanAuthController ()

@end

@implementation YoHomeWomanAuthController
- (void)initSubviews {
    [super initSubviews];
...
- (void)tableViewDidTriggerHeaderRefresh {
    ...
    HomeListService *listApi = [[HomeListService alloc] initWithPageNum:self.page pageSize:ceilf(SCREEN_HEIGHT/100) homeType:YoHomeTypeWomanAuth];
