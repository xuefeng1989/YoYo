//
//  YoHomeBaseTableViewController.m
//  Yoyo
//
...
@interface YoHomeBaseTableViewController ()

@end

@implementation YoHomeBaseTableViewController
...
- (void)tableViewDidTriggerHeaderRefresh {
    ...
    HomeListService *listApi = [[HomeListService alloc] initWithPageNum:self.page pageSize:ceilf(SCREEN_HEIGHT/100) homeType:self.listDataType];
