...
extension UIView {
    ...
    @objc public static let statusBarSize = UIApplication.shared.statusBarFrame.size
    @objc public static let navigationBarSize = CGSize(width: statusBarSize.width, height: 44.0)
    @objc public static let statusBarNavigationBarSize = {() -> CGSize in
        var size = statusBarSize
        size.height += navigationBarSize.height
        return size
    }()
    @objc public static let safeAreaBottom = UIEdgeInsets.safeAreaInsets.bottom
...
extension UIColor {
    ...
    @objc public static let ks_wordMain = UIColor(red: 33/255.0, green: 39/255.0, blue: 46/255.0, alpha: 1)
    @objc public static let ks_wordMain_2 = UIColor(red: 153/255.0, green: 153/255.0, blue: 153/255.0, alpha: 1)
    @objc public static let ks_background = UIColor(red: 240/255.0, green: 240/255.0, blue: 240/255.0, alpha: 1)
    @objc public static let ks_main = UIColor(red: 102/255.0, green: 69/255.0, blue: 251/255.0, alpha: 1)
    @objc public static let ks_lightMain = UIColor(red: 154/255.0, green: 97/255.0, blue: 213/255.0, alpha: 1)
    @objc public static let ks_lightGray = UIColor(red: 234/255.0, green: 234/255.0, blue: 234/255.0, alpha: 1)
    @objc public static let ks_white = UIColor.white
    @objc public static let ks_black = UIColor.black
    @objc public static let ks_red = UIColor.red
}
