...
@interface YoHotViewController ()<UICollectionViewDelegate, UICollectionViewDataSource, YoPortraitLayoutDelegate>
...
@implementation YoHotViewController
...
- (void)loadNewData {
    self.pageIndex = 0;
    YoPortraitService *portraitApi = [[YoPortraitService alloc] initWithPageIndex:self.pageIndex pageSize:0 sendType:YoPortraitTypeHot];
...
- (CGFloat)waterFlowLayout:(YoPortraitLayout *)waterFlowLayout heigthForItemAtIndex:(NSUInteger)index itemWidth:(CGFloat)itemWidth {
    ...
    //    CGFloat value = itemWidth * data.lastOneInstagram.imgHight / data.lastOneInstagram.imgWidth;
    CGFloat value = itemWidth * (500+arc4random_uniform(300)) / (300+arc4random_uniform(300));
    return value;
}
